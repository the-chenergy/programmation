...
# https://www.hackerrank.com/contests/lpc-2022/challenges/lpc2022-storm-predictor
def solve(case_id):
    a = [0] * 4
    for i in range(4):
        a[i] = 1 if input().split(': ')[1] == 'true' else 0
    print('Go fishing!' if sum(a) <= 2 else 'Wait for the storm to pass.')
