...
inp = '''Game 1: 7 blue, 9 red, 1 green; 8 green; 10 green, 5 blue, 3 red; 11 blue, 5 red, 1 green
...
inp_s = '''Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
for i, line in enumerate(inp):
    ...
    for game in line.split('; '):
        for pick in game.split(', '):
            ...
            num = int(num)
            ct[color] = max(ct[color], num)
    ans += ct['green'] * ct['red'] * ct['blue']
print(ans)
