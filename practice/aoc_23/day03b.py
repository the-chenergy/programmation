...
inp = '''.....487.599...........411...........................................574..679.136..........................30......255.......432............
....*......*............*..........&586..........................375...@..*....../.....835.............610*........./...............582.....
...
for y in range(h):
    for x in range(w):
        ...
        if inp[y][x].isdigit():
            ...
            s = ''
            i = x
            while i < w and inp[y][i].isdigit():
                s += inp[y][i]
                vis.add((y, i))
                i += 1
            nums.append((s, y, x))
        else:
            syms.append((inp[y][x], y, x))

ans = 0
ct = defaultdict(list)
for num, y, x in nums:
    x2 = x + len(num) - 1
    for sym, sy, sx in syms:
        if sym != '*':
            continue
        if sy >= y - 1 and sy <= y + 1 and sx >= x - 1 and sx <= x2 + 1:
            ct[(sym, sy, sx)].append(num)
for a in ct.values():
    if len(a) != 2:
        continue
    ans += int(a[0]) * int(a[1])
